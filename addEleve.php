...
if (isset($_POST['pseudo'], $_POST['nom'], $_POST['prenom'], $_POST['dateNaissance'], $_POST['lieuNaissance'], $_POST['sexe'], $_POST['tel'], $_POST['niveau'])) {
    ...
    $stmtAjoutPersonne = $bdd->prepare("INSERT INTO personnes(pseudo,nom,prenom,dateNaissance,lieuNaissance,statut,passwords,sexe,email,tel,niveau) VALUES ('$pseudo','$nom','$prenom','$dateNaissance','$lieuNaissance','$statut','$passwords','$sexe','$email','$tel','$niveau')");
